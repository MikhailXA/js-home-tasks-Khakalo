...
const clock = document.getElementById('clock'),
    eClock = document.createElement('span'),
...
eClock.style.display = 'inline-block';
eClock.style.fontSize = '21px';
eClock.style.position = 'absolute';
eClock.style.top = '45px';
eClock.style.left = '65px';
clock.appendChild(eClock);
...
function getTime() {
    ...
    eClock.innerText = `${hours}:${minutes}:${seconds}`;
